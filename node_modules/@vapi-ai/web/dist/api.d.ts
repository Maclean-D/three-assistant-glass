export interface DeepgramTranscriber {
    ...
    language?: 'bg' | 'ca' | 'cs' | 'da' | 'da-DK' | 'de' | 'de-CH' | 'el' | 'en' | 'en-AU' | 'en-GB' | 'en-IN' | 'en-NZ' | 'en-US' | 'es' | 'es-419' | 'es-LATAM' | 'et' | 'fi' | 'fr' | 'fr-CA' | 'hi' | 'hi-Latn' | 'hu' | 'id' | 'it' | 'ja' | 'ko' | 'ko-KR' | 'lt' | 'lv' | 'ms' | 'nl' | 'nl-BE' | 'no' | 'pl' | 'pt' | 'pt-BR' | 'ro' | 'ru' | 'sk' | 'sv' | 'sv-SE' | 'ta' | 'taq' | 'th' | 'th-TH' | 'tr' | 'uk' | 'vi' | 'zh' | 'zh-CN' | 'zh-Hans' | 'zh-Hant' | 'zh-TW';
    /**
...
export interface CreateTransferCallToolDTO {
    ...
    destinations?: (AssistantTransferDestination | NumberTransferDestination | SipTransferDestination)[];
    /**
     * This is the function definition of the tool.
     *
     * For `endCall`, `transferCall`, and `dtmf` tools, this is auto-filled based on tool-specific fields like `tool.destinations`. But, even in those cases, you can provide a custom function definition for advanced use cases.
...
export interface CreateAssistantDTO {
    ...
    model?: AnyscaleModel | AnthropicModel | CustomLLMModel | DeepInfraModel | GroqModel | OpenAIModel | OpenRouterModel | PerplexityAIModel | TogetherAIModel;
    /**
     * These are the options for the assistant's voice.
     * @default {"provider":"playht","voiceId":"jennifer"}
     */
    voice?: AzureVoice | CartesiaVoice | DeepgramVoice | ElevenLabsVoice | LMNTVoice | NeetsVoice | OpenAIVoice | PlayHTVoice | RimeAIVoice;
    /**
     ...
     */
    serverMessages?: ('conversation-update' | 'end-of-call-report' | 'function-call' | 'hang' | 'model-output' | 'phone-call-control' | 'speech-update' | 'status-update' | 'transcript' | 'tool-calls' | 'transfer-destination-request' | 'user-interrupted' | 'voice-input')[];
    /**
...
export interface Call {
    ...
    messages?: (UserMessage | SystemMessage | BotMessage | FunctionCallMessage | ToolCallMessage | ToolCallResultMessage | FunctionResultMessage)[];
    /**
...
export interface AzureOpenAICredential {
    ...
    /** @example ["gpt-4-0125-preview","gpt-4-0613"] */
    models: ('gpt-4o-2024-05-13' | 'gpt-4-turbo-2024-04-09' | 'gpt-4-0125-preview' | 'gpt-4-1106-preview' | 'gpt-4-0613' | 'gpt-35-turbo-0125' | 'gpt-35-turbo-1106')[];
    /** This is not returned in the API. */
    openAIKey: string;
    /** This is the unique identifier for the credential. */
    id: string;
...
export interface ClientMessage {
    ...
    message: ClientMessageConversationUpdate | ClientMessageHang | ClientMessageMetadata | ClientMessageModelOutput | ClientMessageSpeechUpdate | ClientMessageTranscript | ClientMessageToolCalls | ClientMessageToolCallsResult | ClientMessageUserInterrupted | ClientMessageVoiceInput;
}
...
export interface ServerMessage {
     ...
     */
    message: ServerMessageAssistantRequest | ServerMessageConversationUpdate | ServerMessageEndOfCallReport | ServerMessageHang | ServerMessageModelOutput | ServerMessagePhoneCallControl | ServerMessageSpeechUpdate | ServerMessageStatusUpdate | ServerMessageToolCalls | ServerMessageTransferDestinationRequest | ServerMessageTranscript | ServerMessageUserInterrupted | ServerMessageVoiceInput;
}
...
export interface ServerMessageResponse {
     ...
     */
    messageResponse: ServerMessageResponseAssistantRequest | ServerMessageResponseToolCalls | ServerMessageResponseTransferDestinationRequest;
}
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    tool: {
        ...
        toolControllerCreate: (data: ({
            ...
            type: 'transferCall';
        } & CreateTransferCallToolDTO), params?: RequestParams) => Promise<HttpResponse<({
            type: 'dtmf';
        } & DtmfTool) | ({
            type: 'endCall';
        } & EndCallTool) | ({
    ...
    metrics: {
         ...
         * @secure
         */
        metricsControllerFindAllDeprecated: (query?: {
            /**
    ...
    analytics: {
         ...
         * @secure
         */
        metricsControllerQuery: (data: AnalyticsQueryDTO, params?: RequestParams) => Promise<HttpResponse<AnalyticsQueryResult[], any>>;
    };
    log: {
        /**
         * No description
    ...
    org: {
         ...
         * @secure
         */
        orgControllerUserInvite: (id: string, data: InviteUserDTO, params?: RequestParams) => Promise<HttpResponse<void, any>>;
    };
    provider: {
        /**
         * No description
    ...
    voiceLibrary: {
         ...
         * @secure
         */
        voiceLibraryControllerVoiceGetByProvider: (provider: '11labs' | 'azure' | 'cartesia' | 'deepgram' | 'lmnt' | 'neets' | 'openai' | 'playht' | 'rime-ai', params?: RequestParams) => Promise<HttpResponse<VoiceLibrary[], any>>;
        /**
         * No description
         *
         * @tags Voice Library, extended
         ...
         * @secure
         */
        voiceLibraryControllerVoiceLibrarySyncByProvider: (provider: '11labs' | 'azure' | 'cartesia' | 'deepgram' | 'lmnt' | 'neets' | 'openai' | 'playht' | 'rime-ai', params?: RequestParams) => Promise<HttpResponse<VoiceLibrary[], any>>;
        /**
         * No description
         *
