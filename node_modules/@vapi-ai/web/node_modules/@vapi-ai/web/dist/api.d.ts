...
export interface CreateTransferCallToolDTO {
    ...
    destinations?: (AssistantTransferDestination | PhoneNumberTransferDestination | SipTransferDestination)[];
    /**
     * This is the function definition of the tool.
     *
     * For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, this is a custom function definition.
...
export interface TogetherAIModel {
     ...
     */
    tools?: (CreateTransferCallToolDTO | CreateFunctionToolDTO | CreateEndCallToolDTO | CreateDtmfToolDTO | CreateMakeToolDTO | CreateGhlToolDTO)[];
    /**
...
export interface DeepgramTranscriber {
    ...
    language?: 'bg' | 'ro' | 'cs' | 'da' | 'da-DK' | 'de-CH' | 'nl' | 'en' | 'en-US' | 'en-AU' | 'en-GB' | 'en-NZ' | 'en-IN' | 'nl-BE' | 'fr' | 'fr-CA' | 'de' | 'el' | 'hi' | 'hi-Latn' | 'id' | 'it' | 'ja' | 'ko' | 'ko-KR' | 'no' | 'pl' | 'pt' | 'pt-BR' | 'ru' | 'es' | 'es-419' | 'sv' | 'sv-SE' | 'tr' | 'uk' | 'zh' | 'zh-CN' | 'zh-TW';
    /**
...
export interface CreateAssistantDTO {
     ...
     */
    voice?: AzureVoice | DeepgramVoice | ElevenLabsVoice | LMNTVoice | NeetsVoice | OpenAIVoice | PlayHTVoice | RimeAIVoice | CartesiaVoice;
    /**
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    tool: {
        ...
        toolControllerCreate: (data: ({
            ...
            type: 'function';
        } & CreateFunctionToolDTO), params?: RequestParams) => Promise<HttpResponse<({
            type: 'make';
        } & MakeTool) | ({
            type: 'ghl';
        } & GhlTool) | ({
        ...
        toolControllerUpdate: (id: string, data: ({
            ...
            type: 'function';
        } & UpdateFunctionToolDTO), params?: RequestParams) => Promise<HttpResponse<({
            type: 'make';
        } & MakeTool) | ({
            type: 'ghl';
        } & GhlTool) | ({
